...
function createInterface( diy, editor ) {
	...
	shipItems[18] = ListItem( 'sheatipede', @xw-ship-sheatipede-name );
	shipItems[19] = ListItem( 'bsf17bomber', @xw-ship-bsf17bomber-name );
	shipItems[20] = ListItem( 'tiefighter', @xw-ship-tiefighter-name );
	shipItems[21] = ListItem( 'tiefofighter', @xw-ship-tiefofighter-name );
	shipItems[22] = ListItem( 'tiesffighter', @xw-ship-tiesffighter-name );
	shipItems[23] = ListItem( 'tieadvanced', @xw-ship-tieadvanced-name );
	shipItems[24] = ListItem( 'tieprototype', @xw-ship-tieprototype-name );
	shipItems[25] = ListItem( 'tieinterceptor', @xw-ship-tieinterceptor-name );
	shipItems[26] = ListItem( 'tiebomber', @xw-ship-tiebomber-name );
	shipItems[27] = ListItem( 'tiedefender', @xw-ship-tiedefender-name );
	shipItems[28] = ListItem( 'tiephantom', @xw-ship-tiephantom-name );
	shipItems[29] = ListItem( 'tiepunisher', @xw-ship-tiepunisher-name );
	shipItems[30] = ListItem( 'tiestriker', @xw-ship-tiestriker-name );
	shipItems[31] = ListItem( 'tieaggressor', @xw-ship-tieaggressor-name );
	shipItems[32] = ListItem( 'lambdashuttle', @xw-ship-lambdashuttle-name );
	shipItems[33] = ListItem( 'upsilonshuttle', @xw-ship-upsilonshuttle-name );
	shipItems[34] = ListItem( 'vt49', @xw-ship-vt49-name );
	shipItems[35] = ListItem( 'tiesilencer', @xw-ship-tiesilencer-name );
	shipItems[36] = ListItem( 'starwing', @xw-ship-starwing-name );
	shipItems[37] = ListItem( 'firespray31', @xw-ship-firespray31-name );
	shipItems[38] = ListItem( 'ywingalt', @xw-ship-ywingalt-name );	
	shipItems[39] = ListItem( 'headhunteralt', @xw-ship-headhunteralt-name );
	shipItems[40] = ListItem( 'hwk290alt', @xw-ship-hwk290alt-name );
	shipItems[41] = ListItem( 'firespray31alt', @xw-ship-firespray31alt-name );
	shipItems[42] = ListItem( 'm3a', @xw-ship-m3a-name );
	shipItems[43] = ListItem( 'g1a', @xw-ship-g1a-name );
	shipItems[44] = ListItem( 'quadjumper', @xw-ship-quadjumper-name );
	shipItems[45] = ListItem( 'scurrg', @xw-ship-scurrg-name );
	shipItems[46] = ListItem( 'kihraxz', @xw-ship-kihraxz-name );
	shipItems[47] = ListItem( 'starviper', @xw-ship-starviper-name );
	shipItems[48] = ListItem( 'protectorate', @xw-ship-protectorate-name );
	shipItems[49] = ListItem( 'lancer', @xw-ship-lancer-name );
	shipItems[50] = ListItem( 'aggressor', @xw-ship-aggressor-name );
	shipItems[51] = ListItem( 'yv666', @xw-ship-yv666-name );
	shipItems[52] = ListItem( 'jumpmaster', @xw-ship-jumpmaster-name );
	shipItems[53] = ListItem( 'kimogila', @xw-ship-kimogila-name );
